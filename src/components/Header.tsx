    ...
    <header className="header">
      <div className="container nav">
        <Link href="/" className="header-brand">
          <div className="header-logo">
            ...
            >
              ...
              <path
                d="M16 8C11.6 8 8 11.6 8 16C8 20.4 11.6 24 16 24C20.4 24 24 20.4 24 16C24 11.6 20.4 8 16 8ZM14 20L10 16L11.4 14.6L14 17.2L20.6 10.6L22 12L14 20Z"
                fill="white"
              />
              <defs>
                <linearGradient
        ...
        <nav className="header-nav">
          ...
          <Link href="/examples" className="header-nav-link">
            Examples
          </Link>

      ...
      <div className="container space-y-6">
        <Card className="overflow-hidden border-white/90 bg-[linear-gradient(135deg,rgba(255,255,255,0.92),rgba(232,243,255,0.9))]">
          <CardContent className="grid gap-6 p-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:p-8">
            <div className="space-y-4">
              <Badge className="w-fit" variant="secondary">quiet premium gifting</Badge>
              <div className="space-y-3">
                <div className="footer-title">Memories4U</div>
                <p className="max-w-[44ch] text-base leading-7 text-slate-600">
                  Fuer Geburtstage, bei denen ein Standardgeschenk nicht reicht: ein ruhiger, klarer digitaler Ablauf von Erinnerung zu finaler Story.
                </p>
              </div>
            ...
            <div className="grid gap-4 rounded-[28px] border border-white/80 bg-white/76 p-5 shadow-[0_18px_40px_rgba(148,163,184,0.12)]">
              <div>
                ...
                <p className="mb-0 mt-3 text-sm leading-7 text-slate-600">
                  {orderingAvailable
                    ? 'Starte das Briefing, sichere den Auftrag im Checkout und verfolge danach alles ueber dieselbe Statusseite.'
                    : 'Neue Bestellungen sind pausiert, aber bestehende Auftraege lassen sich weiterhin sauber verfolgen.'}
                </p>
              </div>
              <div className="flex flex-wrap gap-3">
                <Button asChild>
                  <Link href={orderingAvailable ? '/memories' : '/status'}>
                    {orderingAvailable ? 'Briefing starten' : 'Status oeffnen'}
                    <ArrowUpRight />
                  </Link>
                </Button>
        ...
        <div className="footer-grid">
          <div className="footer-meta">
            <span>Apple-inspirierte Ruhe, helle Flaechen, klare Hierarchie und moeglichst wenig Reibung im Funnel.</span>
            <span>
              {orderingAvailable

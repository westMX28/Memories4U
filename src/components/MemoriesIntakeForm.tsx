          ...
          <div className="upload-grid">
            <label className="upload-field">
              ...
              <p className="copy text-sm">
                Pflichtfeld. Akzeptiert PNG, JPG und JPEG.
              </p>
              {image1File ? (
            ...
            <label className="upload-field">
              ...
              />
              <p className="copy text-sm">
                Optional fuer eine zweite Perspektive oder den anderen Menschen.
              </p>
              {image2File ? (
                <div className="upload-file-row">
                  <strong className="upload-file-name">
          ...
          {recoveryState ? (
            <div className="rounded-[24px] border border-sky-200 bg-sky-50/85 px-5 py-4 text-sm leading-7 text-slate-700">
              ...
              <span className="block">
                Falls der Checkout nicht geladen hat, kannst du dieselbe Bestellung ueber die
                Statusseite wieder oeffnen und die Bezahlung spaeter fortsetzen.
              </span>
